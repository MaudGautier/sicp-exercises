    ...
    ((product? exp)
      (make-sum
        ...
        (make-product (deriv (multiplier exp) var)
          (multiplicand exp))))
    ((exponentiation? exp)
      ;      (newline) (display "IS EXPONENT CASE")
      ;      (newline) (display "exponent=") (display (exponent exp))
      ;      (newline) (display "base=") (display (base exp))
      ;      (newline) (display "make-exponentiation u n-1=") (display (make-exponentiation (base exp) (make-subtraction (exponent exp) 1)))
      ;      (newline) (display "product=") (display (make-product
      ;          (exponent exp)
